...
CREATE TABLE IF NOT EXISTS `cursos_alunos` (
  ...
  CONSTRAINT `FK_cursos_alunos_alunos` FOREIGN KEY (`id_aluno`) REFERENCES `alunos` (`id`),
  CONSTRAINT `FK_cursos_alunos_cursos` FOREIGN KEY (`id_curso`) REFERENCES `cursos` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

-- Copiando dados para a tabela escola.cursos_alunos: ~0 rows (aproximadamente)
